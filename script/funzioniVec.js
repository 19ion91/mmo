...
function cambiaT(){
	...
	//	$("#desc")[0].innerHTML=description[$(this).parent().attr("id")].replace("v1",(parseInt([$(this)[0].value])*25).toString(););
...
//$(window).on("select",function(){$("option.atr").hover(function(){$("#desc")[0].innerHTML="ciao pippo";});});
...
$(document).ready(function(){
    $("option.atr").hover(
		function() {
				...
				//var desc = $("#desc");
				//desc.finish();
        $("#desc").innerHTML =description[$(this).parent().attr("id")].replace("v1",parseInt([$(this)[0].value])*25);
